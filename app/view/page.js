    ...
    <div className={`min-h-screen bg-gradient-to-br ${themes[currentTheme]} py-12 px-4 relative overflow-hidden`} ref={containerRef}>
        ...
        <div className="flex space-x-2">
          {Object.keys(themes).map(theme => (
            <button
              ...
              style={{ backgroundColor: theme === 'blue' ? '#3b82f6' : theme === 'purple' ? '#8b5cf6' : theme === 'green' ? '#10b981' : '#f97316' }}
            />
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <h1 className="text-6xl font-bold text-gray-900 mb-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-pulse">
            🌟 Content Galaxy 🌟
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-6">
            Immerse yourself in amazing stories and discoveries
          </p>
        ...
        {contents.length === 0 ? (
          <div className="text-center py-16 bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-2 animate-pulse">Awaiting Amazing Content</h3>
            <p className="text-gray-600">Great stories are being crafted... check back soon! ✨</p>
          </div>
        ) : (
              ...
              >
                <div className="md:flex">
                  <div className="md:w-1/3 relative overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 text-sm font-medium text-gray-700 animate-pulse">
                    ...
                    <div className="absolute top-4 right-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white px-3 py-1 rounded-full text-xs font-bold animate-bounce">
                      #{index + 1}
                    </div>
                    <div className="absolute bottom-4 left-4 bg-black/50 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs">
                      📖 {estimateReadingTime(content.text)} min read
                    </div>
                  </div>
                  ...
                  <div className="md:w-2/3 p-8 relative">
                    ...
                    <div className="flex items-center mb-6">
                      <div className="w-14 h-14 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full flex items-center justify-center animate-spin-slow">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        >
                          ...
                          <span className="font-medium">{likes[content._id] || 0}</span>
                        </button>
